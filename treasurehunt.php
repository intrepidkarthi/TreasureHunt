...
logger();
	...
	$query = "insert into logger (ip_addr, emp_id, ref_url, ref_detail, login_out) values('".$ip_addr."','".$emp_id."','".$file_name."','".$ref_details."',0 )";
	...
	mysql_query($query);
	if(!$query)
		die("Issue in TreasureHunt logger");
	unset($query);
	}
...
<tr>
<td align="center">
<img src="./img/norton.jpeg">
</td></tr>
<tr>
<td align="center">
<form method="post" action="wearestrong.php">
...
<div class="silverheader"><a href="#">Your current Level #2</a></div>
...
<!-- ============ FOOTER SECTION ============== -->
<tr>
<td colspan="2" align="center" height="20" ><p style="color:rgb(243,208,10);">Treasure Hunt 2011, Chennai</p></td>
