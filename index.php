...
logger();
	...
	mysql_query($query);
	if(!$query)
		die("Issue in Treasure Hunt logger");
	unset($query);
	}
...
<!-- ============ HEADER SECTION ============== -->
<td colspan="2" style="height: 120px;" ><h1 align="left">SymHunt</h1>
...
<!-- ============ FOOTER SECTION ============== -->
<tr><td colspan="2" align="center" height="20" ><p style="color:rgb(243,208,10);">Treasure Hunt 2011 Chennai</p></td></tr>
</table>  
   </center>
    </body>  
    </html>  
